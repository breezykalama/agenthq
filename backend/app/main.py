...
from app.api.mcp_gateway import agent_credential_router as agent_gateway_credential_router
...
from app.api.mcp_gateway import mcp_protocol_router, rest_gateway_router
...
from app.api.risk_compliance import router as risk_compliance_router
...
def create_app() -> FastAPI:
    app = FastAPI(title="AgentHQ", version="0.8.0", lifespan=lifespan)
    ...
    app.include_router(agent_gateway_credential_router)
    app.include_router(mcp_gateway_router)
    app.include_router(rest_gateway_router)
