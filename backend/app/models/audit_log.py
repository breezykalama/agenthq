...
class AuditAction(StrEnum):
    ...
    MCP_GATEWAY_TOKEN_CREATED = "mcp_gateway.token_created"
    MCP_GATEWAY_TOKEN_REVOKED = "mcp_gateway.token_revoked"
    MCP_GATEWAY_TOKEN_ROTATED = "mcp_gateway.token_rotated"
    AGENT_GATEWAY_CREDENTIAL_CREATED = "agent_gateway_credential.created"
    AGENT_GATEWAY_CREDENTIAL_ROTATED = "agent_gateway_credential.rotated"
    AGENT_GATEWAY_CREDENTIAL_REVOKED = "agent_gateway_credential.revoked"
    AGENT_GATEWAY_CREDENTIAL_USED = "agent_gateway_credential.used"
    AGENT_GATEWAY_CREDENTIAL_DENIED = "agent_gateway_credential.denied"
    MCP_GATEWAY_AUTH_DENIED = "mcp_gateway.auth_denied"
    MCP_GATEWAY_TOOLS_LISTED = "mcp_gateway.tools_listed"
    MCP_GATEWAY_CALL_REQUESTED = "mcp_gateway.call_requested"
    MCP_GATEWAY_CALL_BLOCKED = "mcp_gateway.call_blocked"
    MCP_GATEWAY_CALL_REQUIRES_APPROVAL = "mcp_gateway.call_requires_approval"
    MCP_GATEWAY_CALL_SUCCEEDED = "mcp_gateway.call_succeeded"
    MCP_GATEWAY_CALL_FAILED = "mcp_gateway.call_failed"
